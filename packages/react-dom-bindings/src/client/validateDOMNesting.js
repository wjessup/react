 ...
 * Returns whether
 */
type AncestorValue = keyof AncestorInfoDev;

const ancestorValues: { [key: string]: AncestorValue } = {
...
function findInvalidAncestorForTag(
  ...
  const ancestorValue = ancestorValues[tag];
  return ancestorValue ? ancestorInfo[ancestorValue] : null;
}
