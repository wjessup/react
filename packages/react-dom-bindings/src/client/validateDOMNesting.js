...
type TagToAncestorInfoMap = {
  [tag: string]: keyof AncestorInfo | null,
};

const ancestorInfoMap: TagToAncestorInfoMap = {
...
function findInvalidAncestorForTag(tag: string, ancestorInfo: AncestorInfo): ?Info {
  const ancestorInfoProp = ancestorInfoMap[tag];
  return ancestorInfoProp && ancestorInfo[ancestorInfoProp] ? ancestorInfo[ancestorInfoProp] : null;
}
